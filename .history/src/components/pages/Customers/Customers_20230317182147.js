...
const Customers = () => {
  ...
  const [timers, setTimers] = useState([
    { id: 1, expiryTimestamp: new Date('2023-03-18T00:00:00Z'), onExpire: () => console.warn('Timer 1 has expired!') },
    { id: 2, expiryTimestamp: new Date(), onExpire: () => console.warn('Timer 2 has expired!') },
    { id: 3, expiryTimestamp: new Date(), onExpire: () => console.warn('Timer 3 has expired!') },
  ]);
