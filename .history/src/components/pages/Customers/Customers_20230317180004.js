...
const Customers = () => {
  ...
  const expiryTimestamp = new Date('2023-03-18T00:00:00Z'); // Set the expiration time for the timer
  const {
    seconds,
    minutes,
    hours,
    ...
    expiryTimestamp,
    onExpire: () => console.warn('Timer has expired!'), // Callback function to run when the timer expires
  });
