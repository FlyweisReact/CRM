...
const Customers = () => {
  ...
  const [timers, setTimers] = useState([
    { id: 1, expiryTimestamp: new Date(Date.now() + 1 * 60 * 1000), onExpire: () => alert('Timer 1 has expired!') },
    { id: 2, expiryTimestamp: new Date(Date.now() + 2 * 60 * 1000), onExpire: () => alert('Timer 2 has expired!') },
    { id: 3, expiryTimestamp: new Date(Date.now() + 3 * 60 * 1000), onExpire: () => alert('Timer 3 has expired!') },
  ]);
